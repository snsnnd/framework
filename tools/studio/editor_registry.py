...
NODE_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "processor.custom": {
        ...
        "input_ports": {"sensor": {"contract": "raw_bytes", "type": "uint8_t", "size": 8, "align": 1}},
    ...
    "custom.interface_card": {
        "id": "interface_summary",
        "type": "custom.interface_card",
        "target": "",
        "note": "选择一个目标节点后，Studio 会把它的接口摘要快照同步到这张卡片。",
    },
    "custom.code": {
        "id": "custom_code_note",
        "type": "custom.code",
...
PROPERTY_FIELD_ORDER = {
    ...
    "algorithm.custom": ["id", "type", "module", "algo_type", "input_ports", "primary_input_port", "trigger_policy", "input_contract", "output_contract", "input_type", "output_type", "input_size", "output_size", "output_align", "output_mode", "field_mappings", "process_mode", "output_desc", "run", "ctx_name", "io_contract"],
    "processor.custom": ["id", "type", "module", "description", "input_ports", "primary_input_port", "trigger_policy", "input_contract", "output_contract", "input_type", "output_type", "input_size", "output_size", "input_align", "output_align", "output_mode", "output_desc", "field_mappings", "process_mode", "process", "ctx_name"],
    "module.custom": ["id", "type", "module", "module_type", "input_ports", "primary_input_port", "trigger_policy", "poll_on_event", "output_contract", "input_type", "output_type", "output_size", "output_align", "output_mode", "field_mappings", "process_mode", "output_desc", "ctx_name", "init", "start", "stop", "poll"],
    ...
    "custom.interface_card": ["id", "type", "target", "note"],
