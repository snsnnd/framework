...
PORT_RULES = {
    ...
    "event.publisher": {"in": ["event_source"], "out": ["event"]},
    "event.subscriber": {"out": ["event"]},
    ...
    "logic.switch": {"in": ["event", "sensor", "logic_condition"], "out": ["logic_call"]},
    "logic.for": {"in": ["logic_condition"], "out": ["logic_call"]},
    "data.enum": {"out": ["code"]},
